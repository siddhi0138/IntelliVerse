...
export function GraphAnalyticsPanel({ analytics }: { analytics: GraphAnalytics }) {
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4">
      <h3 className="text-base font-semibold text-slate-900 dark:text-white mb-1">Graph Analytics</h3>
      <p className="text-xs text-slate-500 mb-3">Which records matter most, based on how they connect to everything else.</p>
