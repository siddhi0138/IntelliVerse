...
const KIND_COLORS: Record<string, string> = {
  correlation: "bg-indigo-100 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300",
...
function EvidenceRow({ finding }: { finding: RankedFinding }) {
  ...
  return (
    <li className="border-b border-slate-100 dark:border-slate-800/60 last:border-0 py-2.5">
      ...
      {open && (
        <pre className="mt-2 text-xs bg-slate-50 dark:bg-slate-800/60 rounded-lg p-3 overflow-x-auto text-slate-600 dark:text-slate-400">
